...
public class Flight {
    ...
    public void distanceMeasurementInstructions() {
        String sybl = "+---------------------------+";
        System.out.printf("\n\n %100s\n %100s", sybl,"| SOME IMPORTANT GUIDELINES |");
        System.out.printf("\n %100s\n", sybl);
        System.out.println("\n\t\t1. Distance between the destinations are based upon the Airports Coordinates(Latitudes && Longitudes) based in those cities");
        System.out.println("\t\t2. Actual Distance of the flight may vary from this approximation as Airlines may define their on Travel Policy ignoring that may restrict the planes to fly through specific regions.");
